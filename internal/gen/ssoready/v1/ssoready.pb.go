...
const file_ssoready_v1_ssoready_proto_rawDesc = "" +
	...
	"\x17has_client_bearer_token\x18\x06 \x01(\bR\x14hasClientBearerToken\"\xaf\x01\n" +
	"\bSCIMUser\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12*\n" +
	...
	"#AdminRotateSCIMDirectoryBearerToken\x127.ssoready.v1.AdminRotateSCIMDirectoryBearerTokenRequest\x1a8.ssoready.v1.AdminRotateSCIMDirectoryBearerTokenResponseB\xb0\x01\n" +
	"\x0fcom.ssoready.v1B\rSsoreadyProtoP\x01ZAgithub.com/Civia-Inc/ssoready/internal/gen/ssoready/v1;ssoreadyv1\xa2\x02\x03SXX\xaa\x02\vSsoready.V1\xca\x02\vSsoready\\V1\xe2\x02\x17Ssoready\\V1\\GPBMetadata\xea\x02\fSsoready::V1b\x06proto3"
